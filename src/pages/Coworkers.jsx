        ...
        <div className="worker-window">
          ...
          <div className="worker__content">
            <aside className="worker__aside">
              ...
              <input
                className="worker__input add-coworkers_inputs"
                id="number"
              />
              ...
              <input
                ...
                type="text"
              />
              <label className="worker__label select" id="division">
                Подразделение
              </label>
              <div
                className="worker__select"
                onMouseOver={(e) =>
                  (document.querySelector("#division-items").style.display =
                    "block")
                }
              >
                <span className="worker__item-type" id="division-description">
                  Администрация
                </span>{" "}
                <img src={f} />
                <div
                  className="worker__select-items"
                  id="division-items"
                  onMouseLeave={(e) =>
                    (document.querySelector("#division-items").style.display =
                      "none")
                ...
                >
                  ...
                  <div className="worker__select-item">
                    Технический персонал
                  </div>
                </div>
              </div>
              <label className="worker__label" style={{ width: 110 + "px" }}>
                Должность
              </label>
              <input
                className="worker__input add-coworkers_inputs"
              ...
              >
                <span className="worker__item-type" id="payment-description">
                  Ставка
                </span>{" "}
                <img src={f} />
                <div
                  ...
                  onClick={(e) => {
                    if (e.target.className == "worker__select-item") {
                      document.querySelector("#payment-description").innerText =
                        e.target.innerText;
                    }
                  }}
                >
            ...
            <div className="worker__fields">
              <div className="worker__field-inputs">
                <div className="worker__field-input-box">
                  ...
                  <input
                    className="worker__field-input add-coworkers_inputs"
                    id="fio"
                  />
                </div>
              ...
              <input
                className="worker__field-input just-input add-coworkers_inputs"
                id="address"
              />
              ...
              <input
                className="worker__commentary add-coworkers_inputs"
                id="commentary"
              />
              <label className="worker__label add-doc">
                Прикрепить документ
              </label>
              <div className="worker__add-document">
                <input
                  ...
                  onChange={(e) => {
                    documents = Funcs.uploadFile(e.target.files[0], documents, {
                      document: e.target.dataset.document,
                      blob: e.target.files[0],
                    });
                    document
                      .querySelector(`.${e.target.dataset.document}`)
                      .classList.add("activeDoc");
                  }}
                />
                <input
                  type="file"
                ...
                <div className="add-document-items">
                  <label htmlFor="passport">
                    <a className="add-document-item not-active passport">
                      <i class="fas fa-file-word"></i> Паспорт
                    </a>
                  </label>
                  <label htmlFor="snls">
                    <a className="add-document-item not-active snls">
                      <i class="fas fa-file-word"></i> СНИЛС
                    </a>
                  </label>
                  <label htmlFor="army">
                    <a className="add-document-item not-active army">
                      <i class="fas fa-file-word"></i> Военный билет
                    </a>
                  </label>
                  <label htmlFor="work">
                    <a className="add-document-item not-active work">
                      <i class="fas fa-file-word"></i> Трудовой договор
                    </a>
                  </label>
                </div>
                <div className="add-document-items">
                  <label htmlFor="card">
                    <a className="add-document-item not-active card">
                      <i class="fas fa-file-word"></i> Миграц. карта
                    </a>
                  </label>
                  <label htmlFor="patent">
                    <a className="add-document-item not-active patent">
                      <i class="fas fa-file-word"></i> Патент
                    </a>
                  </label>
                  <label htmlFor="registration">
                    <a className="add-document-item not-active registration">
                      <i class="fas fa-file-word"></i> Регистрация
                    </a>
                  </label>
                </div>
              </div>
              ...
              <div className="window__btns worker-btns">
                <button
                  className="worker-btn window__btn"
                  onClick={(e) => {
                    document.querySelector(".black-co-bg").style.display =
                      "none";
                    document.querySelector(".worker-window").style.display =
                      "none";
                  }}
                >
                  Закрыть
                ...
                <button
                  className="window__btn worker-btn"
                  onClick={(e) => {
                    setChecked(false);
                    ...
                    if (
                      ...
                      Funcs.checkerLength(
                        document.querySelector("#born-date").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#address").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#fact-address").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#number").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#startWork").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#position").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#paymentSum").value
                      ) &
                      (photo != undefined)
                    ) {
                      newWorker = {
                        ...
                        payment: document.querySelector("#payment-description")
                          .innerText,
                        status: true,
                        foreigner: checked,
                        documents: documents,
        ...
        <div className="eddit-worker-window">
          ...
          <div className="worker__content">
            <aside className="worker__aside">
                ...
                <input
                  ...
                  onChange={(e) => {
                    if (Funcs.checkFileType(e.target.files[0])) {
                      Funcs.fileLoader(
                        e.target.files[0],
                        document.querySelector("#eddit-img")
                      );
                      coworkers.forEach((cw) => {
                        if (cw.number == currentEddit.number) {
              ...
              <label className="worker__label">Номер телефона</label>
              <input
                className="worker__input eddit_coworkers_inputs"
                id="eddit-w-number"
              />
              <label className="worker__label">Дата приема</label>
              <input
                className="worker__input eddit_coworkers_inputs"
                id="eddit-w-startwork"
              />
              <label className="worker__label select">Подразделение</label>
              <div className="worker__select">
                <span
                  className="worker__item-type"
                  id="eddit-division-description"
                  onMouseOver={(e) => {
                    document.querySelector(
                      "#eddit-division-items"
                    ).style.display = "block";
                  }}
                >
                  Администрация
              ...
              <div
                className="worker__select"
                onMouseOver={(e) =>
                  (document.querySelector("#eddit-payment").style.display =
                    "block")
                }
              >
                <span
                  className="worker__item-type"
                  id="eddit-payment-description"
                >
                  Ставка
                </span>{" "}
                <img src={f} />
            ...
            <div className="worker__fields">
              <div className="worker__field-inputs">
                <div className="worker__field-input-box">
                  <label className="worker__label fio">ФИО</label>
                  <input
                    className="worker__field-input eddit_coworkers_inputs"
                    id="eddit-w-fio"
                  />
                </div>
                <div className="worker__field-input-box date-born">
              ...
              <label className="worker__label">Адрес прописки</label>
              <input
                className="worker__field-input just-input eddit_coworkers_inputs"
                id="eddit-w-address"
              />
              <label className="worker__label fac">Фактический адрес</label>
              <input
              ...
              <label className="worker__label">Комментарий</label>
              <input
                className="worker__commentary eddit_coworkers_inputs"
                id="eddit-w-commentary"
              />
              <label className="worker__label add-doc-d">
                Прикрепить документ
              </label>
              <div className="worker__add-document">
                <input
                ...
                <input
                  type="file"
                  id="eddit-registration"
                  data-document="registration"
                  className="add-doc"
                />
                <div className="add-document-items">
                  <label htmlFor="eddit-passport">
                    <a className="add-document-item">
                      <i class="fas fa-file-word"></i> Паспорт{" "}
                      <span className="red">Ред.</span>
                    </a>
                  </label>
              ...
              <div className="window__btns worker-btns">
                ...
                <button
                  ...
                  onClick={(e) => {
                    ...
                    if (
                      Funcs.checkerLength(
                        document.querySelector("#eddit-w-fio").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#eddit-w-born").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#eddit-w-fact").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#eddit-w-address").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#eddit-w-commentary").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#eddit-w-number").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#eddit-w-startwork").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#eddit-w-position").value
                      ) &
                      Funcs.checkerLength(
                        document.querySelector("#eddit-w-payment").value
                      )
                    ) {
                      coworkers.forEach((cw) => {
                        if (cw.number == currentEddit.number) {
                          coworkers[coworkers.indexOf(cw)] = {
                            ...
                            address:
                              document.querySelector("#eddit-w-address").value,
                            commentary: document.querySelector(
                              "#eddit-w-commentary"
                            ).value,
                            number:
                              document.querySelector("#eddit-w-number").value,
                            startWork:
                              document.querySelector("#eddit-w-startwork")
                                .value,
                            division: document.querySelector(
                              "#eddit-division-description"
                            ).innerText,
      ...
      <div className="container coworkers__container">
        <div className="coworkers__nav">
          ...
          <div className="coworkers__nav-categories">
            <div className="coworkers__nav-category">
              ФИО <img src={pl} />
            </div>
            <div className="coworkers__nav-category">
              Номер телефона <img src={pl} />
            </div>
            <div className="coworkers__nav-category">
              Должность <img src={pl} />
            </div>
            <div className="coworkers__nav-category">
              Статус <img src={pl} />
            </div>
          ...
          {coworkers.map((worker) => {
            return (
              <div className="coworkers__file" id={worker.id} key={index++}>
                <div className="coworkers__file-item worker-name">
                  {worker.name}
                </div>
                <div className="coworkers__file-item worker-number">
                  {worker.number}
                </div>
                <div className="coworkers__file-item worker-position">
                  {worker.position}
                </div>
                <div className="coworkers__file-item">
                  <span className={worker.status ? "worker" : "retired"}>
                    {worker.status ? "Действующий" : "Уволен"}
                  </span>
                  <img
                    src={file}
                    className="ancet"
                    onClick={(e) => {
                      coworkers.forEach((cw) => {
                        if (
                          ...
                          Funcs.innerText(
                            "#status",
                            currentEddit.status ? "Удалить" : "Возобновить"
                          );
                          Funcs.innerText(
                            "#eddit-w-fio",
                            currentEddit.name,
                          ...
                          Funcs.innerText(
                            "#eddit-w-address",
                            currentEddit.address,
                            "v"
                          );
                          Funcs.innerText(
                            "#eddit-w-fact",
                            currentEddit.factAddress,
                            "v"
                          );
                          Funcs.innerText(
                            "#eddit-w-commentary",
                            currentEddit.comment,
                            "v"
                          );
                          document.querySelector("#status").className =
                            currentEddit.status ? "retired" : "worker";
                          Funcs.innerText(
                            "#eddit-w-number",
                            currentEddit.number,
                            "v"
                          ...
                          Funcs.innerText(
                            "#eddit-w-startwork",
                            currentEddit.startWork,
                            "v"
                          );
                          Funcs.innerText(
                            "#eddit-w-position",
                            currentEddit.position,
                            "v"
                          );
                          Funcs.innerText(
                            "#eddit-w-payment",
                            currentEddit.paymentSum,
                            "v"
                          );
                          Funcs.fileLoader(
                            currentEddit.profilePhoto,
                            document.querySelector("#eddit-img")
                          );
                        }
                      });
